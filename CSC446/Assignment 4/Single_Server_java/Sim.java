...
public static void main(String argv[]) {
  ...
  MeanInterArrivalTime = 2.5; MeanServiceTime = 2.0;
...
System.out.println( "\tLONG-RUN AVERAGE TIME SPENT IN QUEUE PER CUSTOMER                          " + (SumResponseTime-ServiceTime_sum-InterarrivalTime_sum)/TotalCustomers + "      MINUTES");
